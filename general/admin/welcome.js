...
const { getKonfiguracija, setKonfiguracija } = require('../../../utils/welcomeConfig');
...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub => sub
      .setName('set-message')
      .setDescription('Poruka ({user}, {server}, {username}, {membercount})')
    ...
    .addSubcommand(sub => sub
      ...
      .setDescription('Leave poruka ({user}, {server}, {username}, {membercount})')
      .addStringOption(opt => opt.setName('poruka').setDescription('Poruka').setRequired(true)))
    .addSubcommand(sub => sub
      .setName('leave-color')
  ...
  async execute(interaction) {
    ...
    if (sub === 'set-channel') {
      ...
      setKonfiguracija(guildId, 'welcome', { channelId: ch.id });
      ...
      setKonfiguracija(guildId, 'welcome', { message: msg });
      ...
      setKonfiguracija(guildId, 'welcome', { color: boja });
